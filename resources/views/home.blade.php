...
@section('content')
    <div class="px-4 pt-5 my-5 text-center">
        <h1 class="display-4 fw-bold">Lotto</h1>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">
                The gaming platform that will you the highest chance to win the biggest amount of pot money. 
                You and your friends will earn money when playing together. Play today!
            </p>
